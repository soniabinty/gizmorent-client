        ...
        <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-12 bg-white">
            ...
            <div className="md:w-1/2">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    <span className="text-Primary">Real-Time</span> Gadget Rentals & Secure Payments
                </h2>
                <p className="text-gray-600 mt-4 text-lg">
                    Enjoy instant booking and seamless payment processing with{" "}
                    <span className="font-semibold text-gray-900">GizmoRent</span>. Stay updated on your rentals with real-time notifications
