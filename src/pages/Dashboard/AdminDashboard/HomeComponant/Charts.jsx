  ...
  <div className=" p-4 border border-gray-300 bg-white shadow-lg rounded-lg">
      ...
      <ResponsiveContainer width={550} height={300}>
        <BarChart data={data}>
          ...
          <Tooltip />
          <Bar   radius={[8, 8, 0, 0]} dataKey="value" fill="#8884d8" barSize={15} />
        </BarChart>
      </ResponsiveContainer>
    </div>
    </div>
    ...
    <h2 className="text-2xl font-semibold mb-4">New Users</h2>
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex -space-x-2">
          ...
          <img className="w-10 h-10 rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/women/45.jpg" alt="User2" />
          <img className="w-10 h-10 rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/men/52.jpg" alt="User3" />
          <div className="w-10 h-10 flex items-center justify-center bg-gray-200 text-gray-700 rounded-full border-2 border-white text-sm font-semibold">10+</div>
        </div>
      ...
      <ResponsiveContainer  width={380} height={150}>
        <AreaChart data={percentage}>
          ...
          <YAxis tick={{ fontSize: 12 }} />
          <Tooltip />
          <Area type="monotone" dataKey="users" stroke="#3366FF" fill="rgba(51, 102, 255, 0.2)" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
    </div>
