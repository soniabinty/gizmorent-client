      ...
      <div className="flex flex-col items-center min-h-screen bg-gray-100 p-8">
        ...
        {orders.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full max-w-7xl">
            {orders.map((order) => (
              <div key={order._id} className="bg-white p-4 flex justify-between gap-6 items-center rounded shadow border border-gray-300">
               <div>
               <img
           ...
           <div>
                ...
                <p><strong>Renting:<br /></strong> {order.renting_time} →<br /> {order.returning_time}</p>
           </div>
